            ...
            <div className="bg-gradient-to-r from-orange-400/60 to-orange-300/20 rounded-3xl shadow-2xl overflow-hidden w-full max-w-md mx-4 p-4 border border-white/40 relative">
                ...
                <div className="flex justify-center mb-4">
                    <button
                        ...
                        className={`px-8 py-2 rounded-full font-semibold transition duration-300 ${!isLogin
                            ? 'bg-gradient-to-r from-orange-500 to-orange-400 text-white shadow-lg hover:shadow-xl'
                            : 'bg-white/10 text-orange-500 hover:bg-white/20'
                            }`}
                    >
                         Login
                    </button>
                    <button
                        ...
                        className={`px-8 py-2 rounded-full font-semibold transition duration-300 ml-4 ${isLogin
                            ? 'bg-gradient-to-r from-orange-500 to-orange-400 text-white shadow-lg hover:shadow-xl'
                            : 'bg-white/10 text-orange-500 hover:bg-white/20'
                            }`}
                    >
